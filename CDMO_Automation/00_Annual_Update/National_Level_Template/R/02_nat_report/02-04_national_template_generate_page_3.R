...
# trend map 1
doc <- ph_with(doc, value = external_img(src = img_trend_plot_1),
               location = ph_location(left = 0, top = 2.78,
                                      width = 5.38, height = 3.58))

# trend map 2
doc <- ph_with(doc, value = external_img(src = img_trend_plot_2),
               location = ph_location(left = 0, top = 6.99,
                                      width = 5.38, height = 3.58))

# Add trend map 1 title
doc <- ph_with(doc, value = empty_content(),
               location = ph_location(left = 0.15, top = 2.33, 
                                      width = 2.67, height = 0.44))
...
doc <- ph_with(doc, value = empty_content(),
               location = ph_location(left = 4.98, top = 2.65, 
...
doc <- ph_with(doc, value = empty_content(),
               location = ph_location(left = 0.15, top = 6.23, 
                                      width = 2.67, height = 0.44))
...
doc <- ph_with(doc, value = empty_content(),
               location = ph_location(left = 0.15, top = 6.54, 
                                      width = 3.06, height = 0.44))
...
doc <- ph_with(doc, value = empty_content(),
               location = ph_location(left = 4.98, top = 6.68, 
                                      width = 3.4, height = 2.2))
...
doc <- ph_with(doc, value = empty_content(),
               location = ph_location(left = 0.13, top = 10.43,
                                      width = 2.25, height = 0.28))
